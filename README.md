...
```
.
├── smishing_federated_v4.ipynb   # Notebook principal (exécutable sur Google Colab)
├── rapport_smishing_FL.tex       # Rapport scientifique (LaTeX)
├── rapport_smishing_FL.pdf       # Rapport compilé
├── README.md
